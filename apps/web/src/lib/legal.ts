...
//
// KEEP IN SYNC with the mobile client's copy at
// mailpoppy-mobile/src/legal.ts — the two must read identically. This is what
// the /privacy page renders and the basis for the consent gate on the login form.
//
