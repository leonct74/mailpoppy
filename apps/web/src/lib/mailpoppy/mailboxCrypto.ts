// VENDORED, byte-for-byte, from packages/core/src/mailboxCrypto.ts. Copied here
// (like client.ts/types.ts) because the website's cloud build won't resolve the
// monorepo workspace packages. Keep in sync with core — do not diverge.
//
